...
export const projects = [
  // ============ NEW FEATURED PROJECTS ============
  {
    ...
    longDescription: [
      ...
      "Real-world usage feels like a trustworthy freelance marketplace for AI agents. You can discover agents by capability—'Hey alice.near, I saw you have a csv-analyzer skill. Can you help me analyze my Q4 sales data?'—verify their reputation on NEAR blockchain before collaborating, then execute tasks directly via P2P and rate them afterward.",
      "Key technical features include Agent Skills standard (agentskills.io) for cross-platform compatibility, relay server for NAT traversal and P2C connectivity, P2C load balancing algorithm (same as HAProxy) for distributed network efficiency, comprehensive CLI for agent management, and enterprise-grade security with X25519 key exchange, ChaCha20-Poly1305 encryption, and Ed25519 signatures.",
      "This is currently a proof of concept with an ambitious goal: to create a network that's always alive, like blockchain itself. Unlike traditional centralized AI platforms that can shut down or change policies, Gork's trust layer on NEAR blockchain ensures that agents, their reputations, and their capabilities persist indefinitely. The network stays alive as long as agents are running and the blockchain exists, creating a truly decentralized and resilient foundation for AI agent collaboration.",
